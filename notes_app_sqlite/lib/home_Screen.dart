...
import 'package:notes_app_sqlite/add_notes.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    // getNotes();
    // Provider.of<DbProvider>(context).getinitialnotes();
  }
            ...
            ? ListView.builder(
                ...
                itemBuilder: (_, index) {
                  return ListTile(
                    ...
                    subtitle: Text(
                        allNotes[index][dbref!.COLUMN_NOTE_DESC].toString()),
                    trailing: SizedBox(
                      width: 50,
                      child: Row(
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              ...
                              Provider.of<DbProvider>(context, listen: false)
                                  .deletedata(
                                      allNotes[index][dbref!.COLUMN_NOTE_SNO]);
                            },
                            child: Icon(
                              Icons.delete,
                              color: Colors.red,
